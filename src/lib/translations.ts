...
export const translations = {
    en: {
        ...
        'usage.getUnlimited': 'Get Unlimited',
        ...
        'instructions.toggle': 'Custom Instructions',
        'instructions.toggleDescription': 'Append your own instructions to every transformation',
        'instructions.placeholder': 'Enter instructions to append to the output (e.g., "Always use bullet points", "Keep responses under 100 words")',
        'instructions.manageLibrary': 'Manage Library',
        'instructions.savedInstructions': 'Saved Instructions',
        'instructions.noSavedInstructions': 'No saved instructions yet',
        'instructions.selectToAppend': 'Select instructions to append',
        'instructions.addNew': 'Add New',
        ...
        'instructions.namePlaceholder': 'e.g., Code Style Guide',
        'instructions.content': 'Content',
        'instructions.contentPlaceholder': 'Enter the instruction text to append...',
        'instructions.setAsDefault': 'Auto-select for new transformations',
        'instructions.chars': 'chars',
        'instructions.maxChars': 'max 2000 chars',
        'instructions.maxNameChars': 'max 50 chars',
        'instructions.deleteConfirm': 'Delete this instruction?',
        'instructions.deleteConfirmMessage': 'Are you sure you want to delete "{name}"? This cannot be undone.',
        'instructions.saveCurrent': 'Save Current',
        'instructions.appendedSection': '--- Custom Instructions ---',
        'instructions.appliedLabel': 'Applied Instructions',

        // Billing
        'billing.trial': 'Trial',
        'billing.transformsLeft': 'transforms left',
        'billing.upgrade': 'Upgrade Plan',
        'billing.manageBilling': 'Manage Billing',
        'billing.changePlan': 'Change Plan',
        'billing.freePlan': 'Free Plan',
        'billing.freeTransforms': '20 free transforms/month',

        // Upgrade Modal
        'upgrade.title': 'Upgrade Your Plan',
        'upgrade.freeLimitReachedTitle': "You've Used All Free Transforms",
        'upgrade.freeLimitReachedDescription': "Upgrade to continue transforming prompts and unlock more features.",
        'upgrade.limitReachedTitle': 'Monthly Limit Reached',
        'upgrade.limitReachedDescription': 'Upgrade your plan to get more transformations this month.',
        'upgrade.unlockFeaturesTitle': 'Unlock Premium Features',
        'upgrade.unlockFeaturesDescription': 'Get access to advanced features with a paid plan.',
        'upgrade.description': 'Choose a plan that fits your needs.',
        'upgrade.usedOf': '{used} of {limit} used',
        'upgrade.remaining': 'remaining',
        'upgrade.transformsPerMonth': 'transforms/month',
        'upgrade.perMonth': '/month',
        'upgrade.mostPopular': 'Most Popular',
        'upgrade.allModels': 'All AI models',
        'upgrade.cloudSync': 'Cloud sync',
        'upgrade.prioritySupport': 'Priority support',
        ...
        'settings.passwordChangedMessage': 'Your password has been changed successfully.',
        'settings.passwordChangeError': 'Failed to change password',
        'settings.currentPlan': 'Current Plan',
        'settings.billedAnnually': 'Billed annually',
        'settings.billedMonthly': 'Billed monthly',
        'settings.canceledAt': 'Your subscription will end on',
        'settings.usage': 'Usage',
        'settings.transformationsUsed': 'Transformations used',
        'settings.remaining': 'remaining',
        'settings.resetsOn': 'Resets on',
        'settings.billing': 'Billing',
        'settings.billingDescription': 'Manage your payment method, view invoices, or cancel your subscription.',
        'settings.manageBilling': 'Manage Billing',
        'settings.changePlan': 'Change Plan',
        'settings.noSubscription': 'No Active Subscription',
        'settings.noSubscriptionMessage': 'Upgrade to unlock more transformations and features.',
        ...
        'settings.signInRequiredMessage': 'Please sign in to access your account settings.',
        ...
        'pricing.subtitle': 'Start with a 3-day free trial. Cancel anytime.',
        ...
        'pricing.starterDescription': 'Perfect for getting started',
        'pricing.proDescription': 'For power users',
        'pricing.businessDescription': 'For teams and heavy users',
        'pricing.maxDescription': 'Maximum power for professionals',
        'pricing.faq': 'Frequently Asked Questions',
        'pricing.faq.trial': 'How does the free trial work?',
        'pricing.faq.trialAnswer': "You get full access to your chosen plan for 3 days. Your card is required upfront but won't be charged until the trial ends. Cancel anytime before to avoid charges.",
        'pricing.faq.overage': 'What happens if I exceed my monthly limit?',
        'pricing.faq.overageAnswer': 'You can continue using Hyokai beyond your limit. Overage transformations are charged at a per-use rate based on your plan. Upgrade anytime for a higher limit.',
        'pricing.faq.cancel': 'Can I cancel anytime?',
        'pricing.faq.cancelAnswer': "Yes! You can cancel your subscription at any time. You'll continue to have access until the end of your billing period.",
        'pricing.faq.switch': 'Can I switch plans?',
        'pricing.faq.switchAnswer': "Absolutely! You can upgrade or downgrade at any time. When upgrading, you'll be charged the prorated difference. When downgrading, your new rate starts at the next billing cycle.",
        'pricing.questions': "Have questions? We're here to help.",
        'pricing.contactUs': 'Contact Us',
        'pricing.signUpToStart': 'Sign up to start your free trial',
        'pricing.plan': 'plan',
        'pricing.enterEmail': 'Enter your email',
        'pricing.startTrialFor': 'Start your 3-day free trial for',
        'pricing.emailForAccount': 'Your account will be created after payment.',
        'pricing.continueToPayment': 'Continue to Payment',
        'pricing.secureCheckout': 'Secure checkout powered by Stripe',
        'pricing.invalidEmail': 'Please enter a valid email address',
    ...
    jp: {
        ...
        'instructions.toggle': 'カスタム指示',
        'instructions.toggleDescription': '各変換に独自の指示を追加',
        'instructions.placeholder': '出力に追加する指示を入力（例：「常に箇条書きで」「100語以内で」）',
        'instructions.manageLibrary': 'ライブラリ管理',
        'instructions.savedInstructions': '保存済み指示',
        'instructions.noSavedInstructions': '保存された指示がありません',
        'instructions.selectToAppend': '追加する指示を選択',
        'instructions.addNew': '新規追加',
        'instructions.edit': '編集',
        'instructions.delete': '削除',
        'instructions.save': '保存',
        'instructions.cancel': 'キャンセル',
        'instructions.close': '閉じる',
        'instructions.name': '名前',
        'instructions.namePlaceholder': '例：コードスタイルガイド',
        'instructions.content': '内容',
        'instructions.contentPlaceholder': '追加する指示テキストを入力...',
        'instructions.setAsDefault': '新しい変換で自動選択',
        'instructions.chars': '文字',
        'instructions.maxChars': '最大2000文字',
        'instructions.maxNameChars': '最大50文字',
        'instructions.deleteConfirm': 'この指示を削除しますか？',
        'instructions.deleteConfirmMessage': '「{name}」を削除してもよろしいですか？この操作は元に戻せません。',
        'instructions.saveCurrent': '現在を保存',
        'instructions.appendedSection': '--- カスタム指示 ---',
        'instructions.appliedLabel': '適用された指示',

        // Billing
        'billing.trial': 'トライアル',
        'billing.transformsLeft': '変換残り',
        'billing.upgrade': 'プランをアップグレード',
        'billing.manageBilling': '請求管理',
        'billing.changePlan': 'プラン変更',
        'billing.freePlan': '無料プラン',
        'billing.freeTransforms': '月20回まで無料変換',

        // Upgrade Modal
        'upgrade.title': 'プランをアップグレード',
        'upgrade.freeLimitReachedTitle': '無料変換を使い切りました',
        'upgrade.freeLimitReachedDescription': 'アップグレードして、より多くの変換と機能をご利用ください。',
        'upgrade.limitReachedTitle': '月間上限に達しました',
        'upgrade.limitReachedDescription': 'プランをアップグレードして、今月の変換回数を増やしましょう。',
        'upgrade.unlockFeaturesTitle': 'プレミアム機能をアンロック',
        'upgrade.unlockFeaturesDescription': '有料プランで高度な機能にアクセスできます。',
        'upgrade.description': 'ニーズに合ったプランをお選びください。',
        'upgrade.usedOf': '{limit}回中{used}回使用済み',
        'upgrade.remaining': '残り',
        'upgrade.transformsPerMonth': '変換/月',
        'upgrade.perMonth': '/月',
        'upgrade.mostPopular': '人気No.1',
        'upgrade.allModels': '全AIモデル',
        'upgrade.cloudSync': 'クラウド同期',
        'upgrade.prioritySupport': '優先サポート',
        'upgrade.viewAllPlans': 'すべてのプランを見る',
        'upgrade.maybeLater': 'また今度',
        ...
        'settings.changePasswordDescription': 'アカウントを安全に保つためにパスワードを更新してください。',
        ...
        'settings.passwordChangedMessage': 'パスワードが正常に変更されました。',
        'settings.passwordChangeError': 'パスワードの変更に失敗しました',
        'settings.currentPlan': '現在のプラン',
        'settings.billedAnnually': '年払い',
        'settings.billedMonthly': '月払い',
        'settings.canceledAt': 'サブスクリプションは以下の日に終了します',
        'settings.usage': '利用状況',
        'settings.transformationsUsed': '使用した変換回数',
        'settings.remaining': '残り',
        'settings.resetsOn': 'リセット日',
        'settings.billing': '請求',
        'settings.billingDescription': '支払い方法の管理、請求書の確認、サブスクリプションの解約ができます。',
        'settings.manageBilling': '請求管理',
        'settings.changePlan': 'プラン変更',
        'settings.noSubscription': '有効なサブスクリプションがありません',
        'settings.noSubscriptionMessage': 'アップグレードして、より多くの変換と機能をアンロックしましょう。',
        'settings.viewPlans': 'プランを見る',
        'settings.language': '言語',
        'settings.languageDescription': 'インターフェースの言語を選択してください。',
        'settings.signInRequired': 'ログインが必要です',
        ...
        'pricing.subtitle': '3日間の無料トライアルから始めましょう。いつでも解約可能。',
        'pricing.monthly': '月額',
        'pricing.annual': '年額',
        'pricing.save': '節約',
        ...
        'pricing.perMonth': '/月',
        'pricing.billedAnnually': '年払い',
        'pricing.youSave': '節約額',
        'pricing.switchPlan': 'プラン変更',
        'pricing.startTrial': '無料トライアル開始',
        'pricing.starterDescription': '始めるのに最適',
        'pricing.proDescription': 'パワーユーザー向け',
        'pricing.businessDescription': 'チームとヘビーユーザー向け',
        'pricing.maxDescription': 'プロフェッショナル向けの最大パワー',
        'pricing.faq': 'よくある質問',
        'pricing.faq.trial': '無料トライアルはどのように機能しますか？',
        'pricing.faq.trialAnswer': '選択したプランの全機能を3日間ご利用いただけます。クレジットカードは事前に必要ですが、トライアル終了まで課金されません。いつでも解約して課金を回避できます。',
        'pricing.faq.overage': '月間制限を超えた場合はどうなりますか？',
        'pricing.faq.overageAnswer': '制限を超えてもHyokaiを使い続けることができます。超過変換はプランに応じた従量課金となります。より高い制限のためにいつでもアップグレード可能です。',
        'pricing.faq.cancel': 'いつでも解約できますか？',
        'pricing.faq.cancelAnswer': 'はい！いつでもサブスクリプションを解約できます。請求期間の終了まで引き続きアクセスできます。',
        'pricing.faq.switch': 'プランを変更できますか？',
        'pricing.faq.switchAnswer': 'もちろん！いつでもアップグレードまたはダウングレードできます。アップグレード時は日割り差額が請求されます。ダウングレード時は次の請求サイクルから新料金が適用されます。',
        'pricing.questions': 'ご質問はありますか？お気軽にお問い合わせください。',
        'pricing.contactUs': 'お問い合わせ',
        'pricing.signUpToStart': '無料トライアルを開始するにはサインアップしてください',
        'pricing.plan': 'プラン',
        'pricing.enterEmail': 'メールアドレスを入力',
        'pricing.startTrialFor': '3日間の無料トライアルを開始',
        'pricing.emailForAccount': 'お支払い後にアカウントが作成されます。',
        'pricing.continueToPayment': 'お支払いに進む',
        'pricing.secureCheckout': 'Stripeによる安全なチェックアウト',
        'pricing.invalidEmail': '有効なメールアドレスを入力してください',
        'pricing.checkoutError': 'チェックアウトを開始できませんでした。もう一度お試しください。',
    }
} as const;
